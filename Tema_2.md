...
## Выводы
В данном коде выводятся три строки с использованием функции print(). Каждая строка содержит разные значения:
print(2024-2004):Выводится результат после вычитание двух переменных типа int.
print(89.2 + 51.1): Выводится результат после сложения двух переменных типа float.
print(1732-1000+6.4): Выводится результат после вычитания двух переменных типа int и сложение переменной типа float.
...
print('Здарова, Солнышки!'): Выводится обычная строка.
